...
export const StudentsComponent = () => {
	...
	const toggleFilterVisibile = (): void => {
	...
	return (
		<StudentsComponentDiv>
			...
			<StudentsPageMain
				toggleFilterVisibile={toggleFilterVisibile}
				simplified={simplified}
				studentsList={studentsList}
			/>
			{isFilterVisible ? <Filtration toggleFilterVisibile={toggleFilterVisibile} /> : null}
		</StudentsComponentDiv>
	);
};
